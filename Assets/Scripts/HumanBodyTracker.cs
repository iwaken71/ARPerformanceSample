...
namespace ARPerformanceSample
{

    public class HumanBodyTracker : MonoBehaviour
    {
        [SerializeField]
        [Tooltip("The Skeleton object to be controlled.")]
        GameObject m_SkeletonObject;
        ...
        {
            get { return m_SkeletonObject; }
            set { m_SkeletonObject = value; }
        }
